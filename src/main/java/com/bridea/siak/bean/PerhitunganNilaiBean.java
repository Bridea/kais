...
public class PerhitunganNilaiBean {
	...
	public static void hitungIPS(int semester, KomponenNilai kn) {
		...
		if (tempSmester ==semester) {
			double bobots = hitungBobot(hitungGrade(kn.getKehadiran(), kn.getrTugas(),
					kn.getUts(), kn.getUas()));
			tempB = kn.getSks() * bobots;
			bB = bB + tempB;
			tempSks = tempSks + kn.getSks();
			
			System.out.println("Semester "+semester+"Matakuliah Ke "+kn.getMkKe()+" SKS : "+kn.getSks() +" * bobot : "+bobots+"= Nbobot "+tempB);
			System.out
			 .println("=======================================================");
			if (semester==6) {
				...
				System.out.println("IPS SEMESTER "+(semester-1)+":"+ips[semester-1]);
			}
			...
			System.out.println("IPS Nbobot "+bB+" NSKS "+tempSks);
			System.out.println("IPS SEMESTER "+(semester-1)+":"+ips[semester-2]);
			bB = 0;
	        tempSks =0;
	        System.out
			 .println("=======================================================");
	...
	public static char hitungGrade(double nilaiKehadiran, double tugas, double uts,
			double uas) {
